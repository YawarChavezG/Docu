...
function _nc(cod, tit, ver) {
  return `${cod} ${(tit || '').toUpperCase()} V${ver}`
}
export const listaMaestraDB = [
  { id: '1',  ger: 'CALIDAD',    area: 'Control Calidad',  proc: 'Análisis',    tipo: 'Metodología',  cod: 'CC-MET-287',   ver: '01', tit: 'Alibrom solución oftálmica',           nombre_completo: _nc('CC-MET-287', 'Alibrom solución oftálmica', '01'),           f_ap: '28/03/24', f_ex: '28/03/28', vig: 'Vigente',   est: 'Aprobado', ant: 'CC-MET-286', com: '-', forms: ['F01','F02'] },
  { id: '2',  ger: 'PRODUCCIÓN', area: 'Planta Líquidos',  proc: 'Fabricación', tipo: 'Procedimiento', cod: 'PRO-PRO-012',  ver: '03', tit: 'Limpieza de Tanque Agitador',          nombre_completo: _nc('PRO-PRO-012', 'Limpieza de Tanque Agitador', '03'),          f_ap: '10/01/25', f_ex: '10/01/29', vig: 'Vigente',   est: 'Aprobado', ant: 'PRO-PRO-011', com: '-', forms: ['F01'] },
  { id: '3',  ger: 'LOGÍSTICA',  area: 'Almacenes',        proc: 'Recepción',   tipo: 'Instructivo',  cod: 'INS-LOG-005',  ver: '02', tit: 'Ingreso de Materia Prima',              nombre_completo: _nc('INS-LOG-005', 'Ingreso de Materia Prima', '02'),              f_ap: '05/02/26', f_ex: '05/02/30', vig: 'Vigente',   est: 'Aprobado', ant: 'N/A',        com: '-', forms: ['F01','F02','F03'] },
  { id: '4',  ger: 'RRHH',       area: 'Administración',   proc: 'Inducción',   tipo: 'Manual',       cod: 'MAN-RRHH-001', ver: '05', tit: 'Manual de Bienvenida',                  nombre_completo: _nc('MAN-RRHH-001', 'Manual de Bienvenida', '05'),                  f_ap: '20/11/23', f_ex: '20/11/27', vig: 'Vigente',   est: 'Aprobado', ant: 'N/A',        com: '-', forms: [] },
  { id: '5',  ger: 'CALIDAD',    area: 'Aseguramiento',    proc: 'SIG',         tipo: 'Metodología',  cod: 'MET-CAL-002',  ver: '02', tit: 'Control de Desviaciones',               nombre_completo: _nc('MET-CAL-002', 'Control de Desviaciones', '02'),               f_ap: '12/03/20', f_ex: '12/03/24', vig: 'Vencido',   est: 'Aprobado', ant: 'MET-CAL-001', com: '-', forms: ['F01'] },
  { id: '6',  ger: 'PRODUCCIÓN', area: 'Planta Sólidos',   proc: 'Empaque',     tipo: 'Formulario',   cod: 'FOR-PRO-022',  ver: '01', tit: 'Registro de Temperatura',               nombre_completo: _nc('FOR-PRO-022', 'Registro de Temperatura', '01'),               f_ap: '15/04/26', f_ex: '15/04/30', vig: 'Vigente',   est: 'Aprobado', ant: 'N/A',        com: '-', forms: [] },
  { id: '7',  ger: 'GERENCIA',   area: 'Auditoria',        proc: 'Control',     tipo: 'Procedimiento', cod: 'PRO-LOG-018', ver: '04', tit: 'Auditoria de Inventarios',              nombre_completo: _nc('PRO-LOG-018', 'Auditoria de Inventarios', '04'),              f_ap: '10/05/25', f_ex: '10/05/29', vig: 'Vigente',   est: 'Aprobado', ant: 'PRO-LOG-017', com: '-', forms: ['F01'] },
  // Extras de densidad para ETO
  { id: '8',  ger: 'CALIDAD',    area: 'Control Calidad',  proc: 'Validación',  tipo: 'Procedimiento', cod: 'PRO-CAL-045', ver: '05', tit: 'Procedimiento de Muestreo de Control de Calidad', nombre_completo: _nc('PRO-CAL-045', 'Procedimiento de Muestreo de Control de Calidad', '05'), f_ap: '01/01/26', f_ex: '01/01/27', vig: 'Por vencer', est: 'En revisión', ant: 'N/A', com: 'En proceso de actualización', forms: [] },
  { id: '9',  ger: 'RRHH',       area: 'Administración',   proc: 'SSOO',        tipo: 'Procedimiento', cod: 'PRO-RRHH-001',ver: '06', tit: 'Política de Asistencia',                nombre_completo: _nc('PRO-RRHH-001', 'Política de Asistencia', '06'),                f_ap: '16/04/26', f_ex: '16/04/30', vig: 'Vigente',   est: 'Aprobado', ant: 'N/A',        com: '-', forms: [] },
  { id: '10', ger: 'CALIDAD',    area: 'Aseguramiento',    proc: 'Análisis',    tipo: 'Metodología',  cod: 'MET-CAL-005',  ver: '02', tit: 'Metodología de Análisis HPLC',          nombre_completo: _nc('MET-CAL-005', 'Metodología de Análisis HPLC', '02'),          f_ap: '01/07/25', f_ex: '01/07/29', vig: 'Vigente',   est: 'Aprobado', ant: 'N/A',        com: '-', forms: [] },
  { id: '11', ger: 'PRODUCCIÓN', area: 'Planta Líquidos',  proc: 'Limpieza',    tipo: 'Instructivo',  cod: 'INS-PRO-012',  ver: '03', tit: 'Instructivo de Limpieza de Manufactura', nombre_completo: _nc('INS-PRO-012', 'Instructivo de Limpieza de Manufactura', '03'), f_ap: '12/08/25', f_ex: '12/08/29', vig: 'Vigente',   est: 'Aprobado', ant: 'N/A',        com: '-', forms: [] },
  { id: '12', ger: 'LOGÍSTICA',  area: 'Almacenes',        proc: 'Distribución', tipo: 'Manual',      cod: 'MAN-LOG-003',  ver: '01', tit: 'Manual de Logística y Distribución',    nombre_completo: _nc('MAN-LOG-003', 'Manual de Logística y Distribución', '01'),    f_ap: '05/10/25', f_ex: '05/10/29', vig: 'Vigente',   est: 'En liberación', ant: 'N/A', com: 'Pendiente de firma', forms: ['F01'] },
  { id: '13', ger: 'GERENCIA',   area: 'Gestión Doc.',     proc: 'SGD',         tipo: 'Procedimiento', cod: 'PRO-GER-001', ver: '02', tit: 'Procedimiento de Gestión del Sistema Documental', nombre_completo: _nc('PRO-GER-001', 'Procedimiento de Gestión del Sistema Documental', '02'), f_ap: '15/01/26', f_ex: '15/01/30', vig: 'Vigente', est: 'En corrección', ant: 'N/A', com: 'Observaciones de revisor 2', forms: [] },
  // Obsoletos (solo visibles para ETO)
  { id: '14', ger: 'CALIDAD',    area: 'Control Calidad',  proc: 'Análisis',    tipo: 'Metodología',  cod: 'CC-MET-286',   ver: '01', tit: 'Alibrom solución oftálmica (versión anterior)', nombre_completo: _nc('CC-MET-286', 'Alibrom solución oftálmica (versión anterior)', '01'), f_ap: '20/03/20', f_ex: '20/03/24', vig: 'Obsoleto', est: 'Obsoleto', ant: 'N/A', com: 'Reemplazado por CC-MET-287', obsoleto: true, forms: [] },
  { id: '15', ger: 'PRODUCCIÓN', area: 'Planta Líquidos',  proc: 'Fabricación', tipo: 'Procedimiento', cod: 'PRO-PRO-011', ver: '02', tit: 'Limpieza de Tanques v2',                nombre_completo: _nc('PRO-PRO-011', 'Limpieza de Tanques v2', '02'),                f_ap: '05/01/20', f_ex: '05/01/24', vig: 'Obsoleto', est: 'Obsoleto', ant: 'N/A', com: 'Reemplazado por PRO-PRO-012', obsoleto: true, forms: [] },
  { id: '16', ger: 'CALIDAD',    area: 'Aseguramiento',    proc: 'SIG',         tipo: 'Metodología',  cod: 'MET-CAL-001',  ver: '01', tit: 'Control de Desviaciones v1',            nombre_completo: _nc('MET-CAL-001', 'Control de Desviaciones v1', '01'),            f_ap: '01/03/18', f_ex: '01/03/22', vig: 'Obsoleto', est: 'Obsoleto', ant: 'N/A', com: 'Reemplazado por MET-CAL-002', obsoleto: true, forms: [] },
]
